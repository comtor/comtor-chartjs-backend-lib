...
public class PieChart extends AbstractChartJs {

    private Data data;

    public PieChart() {
        super(ChartJs.TYPE_PIE);
    }

    public PieChart(Options options) {
        super(ChartJs.TYPE_PIE, options);
    }

    public PieChart(Options options, Data data) {
        this(options);
        this.data = data;
    }
